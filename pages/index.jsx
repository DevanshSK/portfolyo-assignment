...
const Index = () => {
  ...
  const userSkills = user?.skills ? user.skills.sort((a, b) => a.sequence - b.sequence).filter(a => a.enabled) : [];
  const userTestimonials = user?.testimonials ? user.testimonials.filter(a => a.enabled) : [];
  ...
  return (
    <Layout pageClassName={"home"}>
                  ...
                  <SwiperSlide className="swiper-slide" key={`user-services-${index}`}>
                    <div className="services-item">
                      ...
                      <a href="#" className="lnk">
                        <div className="pricing-item p-0">
                      ...
                      <div className="testimonials-item">
                        ...
                        <div className="info">
                          ...
                          <div className="author">
                            <span>{testimonial.position.trim()}</span>
                          </div>
                        </div>
                        <div
                          className="bg-img"
      ...
      {/* Section - Pricing */}
      {/* NOTE: Since pricing data is not available, so we just hide the pricing section. The pricing of the services has been added in the services section.*/}
      {user.pricing &&
      ...
      {/* Section - Blog */}
      {/* NOTE: Since blogs data is not available, so we just hide the blogs section. */}
      {user.blogs &&
