              ...
              <div key={`project-item-${project._id}`} className={`works-col col-xs-12 col-sm-12 col-md-12 col-lg-12 ${techStack}`}>
                ...
                >
                  ...
                  <div className="desc">
                    ...
                    <div className="text">
                      <p>
                        {project.description || "Lorem ipsum dolor sit amet, consectetur adipiscing elit, seddo eiusmod tempor incididunt ut labore et dolore."}
                      </p>
                    </div>
                    <Link legacyBehavior href="/work-single">
                      <a className="lnk">See project</a>
                    </Link>
                    <Link legacyBehavior href={project.liveurl || "/work-single"}>
                      <a className="lnk mt-3">View Live</a>
                    </Link>
                    <Link legacyBehavior href={project.githuburl || "/work-single"}>
                      <a className="lnk mt-3">Github</a>
                    </Link>
                  </div>
                  <div
                    className="bg-img"
